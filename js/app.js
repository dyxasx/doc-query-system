...
const I18N = {
  ...
  translations: {
    zh: {
      ...
      // 批量上传
      batch_drop_hint: "点击选择文件（支持多选）或拖拽到此处",
      file_queue: "文件队列",
      queue_summary: "已选 {n} 个文件，总大小 {s}",
      title_per_file: "标题（默认使用文件名）",
      status_pending: "等待上传",
      status_uploading: "上传中",
      status_success: "成功",
      status_failed: "失败",
      btn_upload_all: "开始上传（{n} 个文件）",
      progress_batch: "正在上传 {i} / {n}...",
      batch_done: "上传完成：成功 {s} 个，失败 {f} 个",
      retry_failed: "重试失败项",
      clear_list: "清空列表",
      btn_upload_again: "继续上传",
      btn_back_admin: "返回管理",
      no_files_selected: "请先选择文件",
    },
    en: {
      ...
      // Batch upload
      batch_drop_hint: "Click to select files (multiple allowed) or drag them here",
      file_queue: "File Queue",
      queue_summary: "{n} file(s) selected, {s} in total",
      title_per_file: "Title (defaults to file name)",
      status_pending: "Pending",
      status_uploading: "Uploading",
      status_success: "Success",
      status_failed: "Failed",
      btn_upload_all: "Upload {n} File(s)",
      progress_batch: "Uploading {i} / {n}...",
      batch_done: "Finished: {s} succeeded, {f} failed",
      retry_failed: "Retry Failed",
      clear_list: "Clear List",
      btn_upload_again: "Upload More",
      btn_back_admin: "Back to Admin",
      no_files_selected: "Please select files first",
    },
    de: {
      ...
      // Stapel-Upload
      batch_drop_hint: "Dateien auswählen (Mehrfachauswahl) oder hierher ziehen",
      file_queue: "Datei-Warteschlange",
      queue_summary: "{n} Datei(en) ausgewählt, insgesamt {s}",
      title_per_file: "Titel (standardmäßig der Dateiname)",
      status_pending: "Ausstehend",
      status_uploading: "Wird hochgeladen",
      status_success: "Erfolgreich",
      status_failed: "Fehlgeschlagen",
      btn_upload_all: "{n} Datei(en) hochladen",
      progress_batch: "Lade {i} / {n} hoch ...",
      batch_done: "Abgeschlossen: {s} erfolgreich, {f} fehlgeschlagen",
      retry_failed: "Fehlgeschlagene wiederholen",
      clear_list: "Liste leeren",
      btn_upload_again: "Weitere hochladen",
      btn_back_admin: "Zurück zur Verwaltung",
      no_files_selected: "Bitte zuerst Dateien auswählen",
    },
  },
...
// 文件访问 URL（默认走 API；静态部署版由 static-adapter.js 覆盖）
function docFileUrl(docId) {
